...
const displayPhones = (phones, dataLimit) => {
  ...
  phones.forEach((phone) => {
    ...
    phoneDiv.innerHTML = `
        <div class="card ">
              <img src="${phone.image}" class="card-img-top w-50 mx-auto px-3 pt-3" alt="..." />
              <div class="card-body">
...
const displayPhoneDetails = (phone) => {
  ...
  <p>Others: ${phone.others.Bluetooth ?phone.others.Bluetooth : 'No Bluetooth information found' }</p>
